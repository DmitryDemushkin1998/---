...
В рамках 2 лабораторной работы было разработано простое приложение.

      Разработанный сайт позволит ООО «АВМ-Энерго» продвигать свою продукцию на рынке, а также делиться разными новостями.
    
        Была сформирована команда (The Legendary Four)
